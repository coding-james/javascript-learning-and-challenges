// DONE: Add your import statements here.
...
// DONE: Get the companies and roles using the salaryData module.
...
function updateResults() {
    ...
    // DONE: Use the workAroundModule functions to calculate the needed data.
